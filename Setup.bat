...
%SCHTASKS% /Create /TN "Syncthing\AddSpeedLimit" /XML "%SCRIPT_DIR%AddSpeedLimit.xml" /F

REM === RemoveSpeedLimit Task ===
echo Importing RemoveSpeedLimit task...
%SCHTASKS% /Create /TN "Syncthing\RemoveSpeedLimit" /XML "%SCRIPT_DIR%RemoveSpeedLimit.xml" /F
